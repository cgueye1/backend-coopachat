          ...
          <div class="w-1/2 h-full p-8 p-12 flex flex-col justify-center sm:px-16">
            ...
            <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="space-y-6">
              <div>
                ...
                <!-- <div *ngIf="loginForm.get('username')?.invalid && loginForm.get('username')?.touched" class="mt-1">
                  <p class="text-red-500 text-xs">Le nom d'utilisateur est requis</p>
                </div> -->
              </div>
              ...
              <div>
                ...
                <!-- TODO: Afficher les erreurs de validation du mot de passe -->
                <!-- <div *ngIf="loginForm.get('password')?.invalid && loginForm.get('password')?.touched" class="mt-1">
                  <p class="text-red-500 text-xs" *ngIf="loginForm.get('password')?.errors?.['required']">Le mot de passe est requis</p>
                  <p class="text-red-500 text-xs" *ngIf="loginForm.get('password')?.errors?.['minlength']">Le mot de passe doit contenir au moins 6 caractères</p>
                </div> -->
              </div>
              ...
              <div class="flex space-x-4">
                <!-- TODO: API - Connexion avec Google -->
                <button 
                  type="button"
