...
public class AuthController {
        ...
        @Operation(summary = "Modifier mon profil (commercial / responsable logistique)", description = "Met à jour prénom, nom, email et/ou téléphone pour l'utilisateur connecté. "
                        +
        ...
        @Operation(summary = "Demander la réinitialisation de mot de passe", description = "Génère un token de réinitialisation et l'envoie par email à l'utilisateur. "
                        +
